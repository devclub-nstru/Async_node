...
| type | varchar(255) | NOT NULL | e.g. `manual`, `webhook`, `cron` |
...
| trigger_id | integer | NOT NULL, FK → triggers.id | What triggered it |
...
| input_json | jsonb | nullable | Trigger input payload |
